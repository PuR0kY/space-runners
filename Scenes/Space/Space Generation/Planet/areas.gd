...
#
			...
			#var force: Vector3 = dir.normalized() * planet.gravity_strength * (1.0 - dist / planet.gravity_range)
...
#
			...
			#var angle = deg_to_rad(planet.rotation_speed_deg) * delta
