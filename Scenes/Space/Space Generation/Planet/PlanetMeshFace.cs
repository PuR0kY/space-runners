...
public partial class PlanetMeshFace
{
	...
	public PlanetMeshFace(Node parent, int resolution, Vector3 localUp, Material material, Godot.FastNoiseLite[] noises, float radius)
	{
		var highFreqNoise = new Godot.FastNoiseLite();
		highFreqNoise.NoiseType = Godot.FastNoiseLite.NoiseTypeEnum.Simplex;
